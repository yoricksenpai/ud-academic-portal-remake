      ...
      >
        <motion.div variants={itemVariants}>
          ...
          <p className="text-muted-foreground">
            Bienvenue sur votre espace étudiant, PRISO JOHAN YORICK
          </p>
        </motion.div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  +1.2 par rapport au semestre précédent
                </p>
              </CardContent>
            </Card>
            <Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Dernière notification il y a 2 heures
                </p>
              </CardContent>
              <CardFooter className="p-2">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card className="md:col-span-2">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Vos cours des 3 prochains jours
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4 rounded-md border p-4">
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Prof. Mbarga - Salle Informatique 2
                        </p>
                      </div>
                      <div className="flex flex-col items-end">
                    ...
                    <div className="flex items-center space-x-4 rounded-md border p-4">
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Dr. Nkoulou - Salle Informatique 1
                        </p>
                      </div>
                      <div className="flex flex-col items-end">
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          <p className="text-sm font-medium leading-none">
                            Frais de scolarité - 1er versement
                          </p>
                          <p className="text-xs text-muted-foreground">
                            10/01/2023
                          </p>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          <p className="text-sm font-medium leading-none">
                            Frais de scolarité - 2ème versement
                          </p>
                          <p className="text-xs text-muted-foreground">
                            15/03/2023
                          </p>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          <p className="text-sm font-medium leading-none">
                            Frais de scolarité - 3ème versement
                          </p>
                          <p className="text-xs text-muted-foreground">
                            Échéance: 30/05/2023
                          </p>
            ...
            <TabsContent value="notes" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Vos résultats académiques pour le semestre en cours
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="calendar" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Vos cours pour la semaine du 22 au 26 mai 2023
                  </CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <div className="p-4 space-y-2">
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Dr. Essono - Laboratoire Informatique
                            </p>
                          </div>
